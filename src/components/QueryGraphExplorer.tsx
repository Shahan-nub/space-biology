...
export default function QueryGraphExplorer() {
  ...
  const runQuery = () => {
    ...
    try {
      ...
      // Clear highlights when new query runs
    ...
    <div className="w-full max-w-6xl mx-auto mt-10">
      ...
      {graphData.nodes.length > 0 && (
        <div className="mt-10">
          ...
          {/* Graph Container with Side Panel */}
            ...
            <AnimatePresence>
              {selectedNode && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: 20 }}
                  className="w-80 bg-gradient-to-br from-gray-900 via-gray-900 to-indigo-950/40 border border-indigo-500/30 rounded-2xl p-6 shadow-2xl overflow-y-auto max-h-[600px]"
                >
                  {/* Close Button */}
                  <button
                    onClick={() => {
